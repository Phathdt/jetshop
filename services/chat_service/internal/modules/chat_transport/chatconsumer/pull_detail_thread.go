...
func PullDetailThreadConsumer(sc sctx.ServiceContext) func(msg *message.Message) error {
	return func(msg *message.Message) error {
		...
		biz := chat_biz.NewPullDetailThreadBiz(repo, channelClient, publisher, logger)

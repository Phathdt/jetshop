...
import (
	...
	"jetshop/shared/sctx/component/pubsub/redispub"
...
const (
	serviceName = "chat_sync_message_consumer"
	version     = "1.0.0"
)
...
func newServiceCtx() sctx.ServiceContext {
	return sctx.NewServiceContext(
		...
		sctx.WithComponent(redispub.NewRedisPub(common.KeyCompRedisPubsub)),
	)
}
...
var rootCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		subscriber.AddNoPublisherHandler("sync_message", "sync_message", chatconsumer.SyncMessageConsumer(serviceCtx))
